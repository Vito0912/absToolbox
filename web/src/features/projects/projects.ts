...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "This tool automatically converts (and queues) all current and upcoming items in your library to specified codecs using the built-in converter",
    authors: ["Vito0912"],
    authorLinks: ["https://github.com/Vito0912"],
  ...
  },
  {
    id: "bookbot",
    name: "BookBot",
    link: "https://github.com/itsbryanman/bookbot",
    description:
      "audiobook organizer/renamer + DRM removal - Editorial comment: DRM is against law in many countries even for personal use, so don't use",
    authors: ["itsbryanman"],
    authorLinks: ["https://github.com/itsbryanman"],
    tags: ["utility"],
  },
];
...
export const tagDefinitions: Record<string, TagDefinition> = {
  "abs-native": {
    name: "ABS Native",
    description:
      "Apps designed specifically for Audiobookshelf with direct integration",
  },
  "abs-unspecific": {
    name: "ABS Unspecific",
    description:
      "Apps that work with Audiobookshelf but are not specifically designed for it",
  },
  utility: {
    name: "Utility",
