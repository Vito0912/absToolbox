          ...
          <div class="flex items-start justify-between mb-4">
            ...
            <div class="flex flex-col items-end gap-2">
              <div class="flex items-center gap-2">
                ...
                <span
                  v-if="client.heavyAiUsage"
                  class="group/ai relative inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-orange-600/20 text-orange-300 cursor-help"
                >
                  Heavy AI Use
                  <div class="absolute bottom-full right-0 mb-2 w-72 p-3 bg-gray-800 rounded-lg shadow-xl opacity-0 invisible group-hover/ai:opacity-100 group-hover/ai:visible transition-all duration-200 z-50">
                    <p class="text-xs text-gray-300 leading-relaxed">
                      <strong class="text-orange-300">Why is this displayed?</strong><br><br>
                      I personally test every app listed here. Apps built heavily with AI tend to change frequently, break more often, and require significantly more time to test and document.<br><br>
                      This badge doesn't reflect the app's quality directly, but indicates that the app was primarily written by AI rather than a human developer. This may result in potential security 
                      concerns, maintainability issues, or unexpected behavior. You need to know for yourself if you want to use an app where most of the code was generated by an AI.<br><br>For testing this means I will test this app less frequently as other apps, written by humans.<br><br>
                      AI usage is completely fine to help. Heavy AI usage for !me! means that code was obviously generated (only or by a big margin) by AI (use comments, non existing features, commits, etc.).
                    </p>
                  </div>
                </span>
              </div>
